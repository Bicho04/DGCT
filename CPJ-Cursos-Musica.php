      ...
      <div id="cont-central">
        ...
        <nav id="botones-entidad">
             ...
             <section id="cont-info">
                <div class="info">
                    <h3>Cursos</h3>
                    <h2>Musica</h2><p>El Conservatorio de Música del Centro Paraguayo Japonés está reconocido por el Ministerio de Educación y Cultura. Ofrece clases individuales y grupales de Piano, Guitarra Popular  eléctrica y Clásica, Violín, Violonchelo, Arpa. Órgano,  Canto y Coro. Taller Musical Infantil</p>
                </div>
              </section>
