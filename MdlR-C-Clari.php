...
<head>
    ...
    <title>Manzana de la Rivera, Centro Cultural de la Ciudad de Asucnión</title> 
            ...
            <ul id="nav-inst"><!--
              ...
              --><li class="col-4"><a href="#">9 casas</a><!-- 
                --><ul><!--  
                    ...
                    --><li><a href="MdlR-C-Vertua.php">Casa Vertúa</a></li><!--  
                    --><li><a href="MdlR-C-Emesa.php">Casa Emesa</a></li><!--  
                    --><li><a href="MdlR-C-Castelvi.php">Casa Castelví</a></li><!--  
                    ...
                    --><li><a href="MdlR-C-GarciaLorca.php">La Sala García Lorca</a></li><!--  
                --></ul><!-- 
              --></li><!-- 
              --><li class="col-4"><a href="MdlR-QuienFue.php">¿Quién Fue?</a></li><!-- 
        ...
        <nav id="botones-entidad">
              ...
              <section id="cont-info">
                <div class="info">
                 <h3>9 Casas</h3>
                 <h2>CASA CLARI</h2>
                 <p> ubicada al lado de la  Casa Viola, es una construcción simple, con una galería interior de  habitaciones corridas, por donde ahora es la entrada principal a la Manzana de  la Rivera. &nbsp;Fue construida en las primeras décadas del siglo XX, con  estilo Art Nouveau tardío. En esta casa funcionan actualmente el Café Bar Casa Clari  y el Espacio Miguel Acevedo, construcciones posteriores en el predio de la Casa  Clari.</p>
                 <p>El Espacio Miguel Acevedo está  destinado a exposiciones de artes visuales, especialmente en pequeño formato:  pinturas, grabados, dibujos, fotografías. Las obras son colocadas sobre pared o  paneles de madera, en un espacio cerrado, y cuenta con luces spots. <br>
                   El CCC tiene personal capacitado para  realizar los montajes de cada exposición. <br>
                   Las exposiciones son de acceso libre y  gratuito, en el horario de: lunes a viernes, 8 a 20 h, sábados y domingos, de 8  a 18 h.<br>
                   (Los artistas plásticos interesados en  exponer deben dirigirse a la Unidad de Espacios del CCC, para retirar  requisitos y condiciones de uso. Teléfonos 442-448, 447-683, int. 109; de lunes  a viernes, de 7:30<br>
                 ...
                 <p>&nbsp;</p>
                 <p>El Café Bar Casa Clari ofrece picadas,  pizzas, hamburguesas, lomitos, tragos especiales y buena música. En su terraza  se puede disfrutar de la imponente vista del Palacio de Gobierno. Atiende de  lunes a viernes, de 9 a 24 h, y los sábados, de 18 a 24 h. Cierra domingos y feriados.  Teléfono: 496-476.</p>
                </div>
              </section>
