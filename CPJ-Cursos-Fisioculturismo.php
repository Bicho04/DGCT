      ...
      <div id="cont-central">
        ...
        <nav id="botones-entidad">
             ...
             <section id="cont-info">
                <div class="info">
                    <h3>Cursos</h3>
                    <h2>Fisiculturismo y Musculación</h2><p>La Sala de Fisiculturismo y Musculación, cuenta con cintas caminadoras, bicicletas estáticas, barras, mancuernas, discos olímpicos y  equipos de musculación y steps para Gimnasia Aeróbica.</p>
                </div>
              </section>
