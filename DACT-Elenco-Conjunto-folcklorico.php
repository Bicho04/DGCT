...
<title>Direcci&oacute;n de Acci&oacute;n Cultural y Turismo</title> 
...
<!-- ******************************************************* -->
    ...
    <section id="central">
      ...
      <div class="titulo"><h1>Direcci&oacute;n de Acci&oacute;n Cultural y Turismo</h1></div>
      ...
      <div id="cont-central">
            ...
            <ul id="nav-inst"><!-- 
              ...
              --><li class="col-2"><a href="DACT-Historia.php">Historia</a></li><!-- 
        ...
        <nav id="botones-entidad">
                ...
                <ul id="botones-entidad-nav">
                    ...
                    <li><a href="DACT-Elenco-Banda-folcklorica.php">Banda Folckl&oacute;rica Municipal</a>

                      <!-- ul> 

                        <li><a href="DACT-Banda-folclorico-municipal-Historia.php">Historia</a></li>  

                        <li><a href="DACT-Banda-folclorico-municipal-Director.php">Director</a></li> 
                    ...
                    <li><a href="DACT-Elenco-Ballet-folcklorico.php">Ballet Folckl&oacute;rico Municipal</a>

                      <!-- <ul> 

                        <li><a href="DACT-Ballet-folclorico-municipal-Historia.php">Historia</a></li>  

                        <li><a href="DACT-Ballet-folclorico-municipal-Director.php">Director</a></li> 
                    ...
                    <li><a href="DACT-Elenco-Conjunto-folcklorico.php">Conjunto Folckl&oacute;rico Municipal</a>

                      <!-- <ul> 

                        <li><a href="DACT-Conjunto-folclorico-municipal-Historia.php">Historia</a></li>  

                        <li><a href="DACT-Conjunto-folclorico-municipal-Director.php">Director</a></li> 
                    ...
                    <li><a href="#">Plazas Tem&aacute;ticas</a>
        ...
        <section id="cont-info">
          ...
          <div class="info">
            <h3>Direcci&oacute;n de Acci&oacute;n de Cultura y Turismo</h3>
            <h2>Conjunto Folckl&oacute;rico Municipal de Asunci&oacute;n</h2>
          <img src="imagenes/fotos/Conjunto Folclorico Municipal2 (2).jpg" class="central" alt="Conjunto Folclorico">
            <p>El Conjunto Folclórico Municipal es una agrupación musical creada hace mas de 40 ańos con el fin de llevar la difusión de la música paraguaya en todos los lugares de nuestra ciudad de Asunción y tener la representación folclórica cultural de la Municipalidad de la Capital.</p>
            <p>Esta agrupación folclórica no solo lleva la representación musical en los barrios de Asunción, sino también por todo el territorio nacional del Paraguay como asi también recorriendo el mundo llevando en alto la representación folclórica de la música paraguaya. Entre estos países podemos citar al Brasil, Uruguay, Argentina, Chile, Japón y EEUU.</p>
            <p>Siguiendo el objetivo de su creador esta agrupación realiza conciertos didácticos para instituciones educativas de todos los niveles durante el ańo, haciendo conocer las diferentes formas de la música paraguaya y sus grandes creadores, como asi también los instrumentos típicos de nuestro país y sus orígenes.</p>
            <p>Con el afán de rescatar a los grandes creadores y compositores de la música paraguaya en los últimos ańos, ha realizado galas de conciertos con temas exclusivamente de un compositor y que fuera homenajeado en su momento, hasta hoy, esta agrupación ha presentado en homenaje a Darío Gómez Serrato, José Asunción Flores y Carlos Miguel Giménez entre otros,</p>
