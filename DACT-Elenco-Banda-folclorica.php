      ...
      <div id="cont-central">
            <ul id="nav-inst"><!-- 
              ...
              --><li class="col-3"><a href="DACT-Elencos-Folcloricos.php">Elencos Folcloricos</a><!-- 
                --><ul><!-- 
                    ...
                    --><li><a href="DACT-Elelnco-Ballet-folclorico.php">Ballet</a></li><!--  
                    --><li><a href="DACT-Elelnco-Conjunto-folclorico.php">Conjunto Folclorico</a></li><!--  
                --></ul><!-- 
              --></li><!-- 
        ...
        <nav id="botones-entidad">
                <ul id="botones-entidad-nav">
                    ...
                    <li><a href="DDACT-Elelnco-Ballet-folclorico.php">Escenario M&oacute;vil</a></li>
        ...
        <section id="cont-info">
          <div class="info">
            <h3>Banda Folclorica</h3>
          <img src="imagenes/fotos/banda y ballet folklorico.jpg" width="2000" height="1333" alt="banda"></div>
        </section>
