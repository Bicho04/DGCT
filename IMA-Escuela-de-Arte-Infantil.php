    ...
    <section id="central">
      ...
      <div id="cont-central">
        ...
        <section id="cont-info">
            ...
            <p>Su propósito es desarrollar la capacidad creativa y expresiva del nińo, buscando a la vez su desarrollo integral. Los nińos son introducidos al mundo del arte, buscando descubrir su vocación artística, para proyectarse posteriormente a las otras escuelas.</p> 
            <p><strong>Contenido:</strong></p>
            <p>Plástica</p>
            <p>Música</p>
            <p>Danza</p>
            <p>Teatro</p>
            <p><strong>Edad:</strong> de 6 a 10 ańos de edad.</p>
            ...
            o cédula de identidad acompańado del original. </p>
            <p><strong>Local:</strong> Escuela de economistas Graduados del Paraguay.
            Mariscal López c/ Tacuary.</p>
