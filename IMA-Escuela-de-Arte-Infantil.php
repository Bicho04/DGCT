    ...
    <section id="central">
      ...
      <div id="cont-central">
        ...
        <section id="cont-info">
            <div class="info">
            <h3>Escuela de Arte Infantil</h3>
            <p>Su prop&oacute;sito es desarrollar la capacidad creativa y expresiva del niño, buscando a la vez su desarrollo integral. Los niños son introducidos al mundo del arte, buscando descubrir su vocaci&oacute;n art&iacute;stica, para proyectarse posteriormente a las otras escuelas.</p> 
            <p><strong>Contenido:</strong></p>
            <p>Pl&aacute;stica</p>
            <p>M&uacute;sica</p>
            <p>Danza</p>
            <p>Teatro</p>
            <p><strong>Edad:</strong> de 6 a 10 años de edad.</p>
            <p><strong>Horario:</strong> Martes a Viernes de 14:30 a 17:30 horas</p>
            <p><strong>Requisitos:</strong> Fotocopia de certificado de nacimiento
            o c&eacute;dula de identidad acompañado del original. </p>
            <p><strong>Local:</strong> Escuela de economistas Graduados del Paraguay.
            Mariscal L&oacute;pez c/ Tacuary.</p>
