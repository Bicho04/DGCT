      ...
      <div id="cont-central">
        ...
        <nav id="botones-entidad">
              ...
              <!-- InstanceBeginEditable name="INFO" -->
               ...
               <div class="info">
                 <h3>9 Casas</h3>
                 <h2>El PATIO LEONO</h2>
                 <p>R era el patio interno  de las casas Castelví y Serra I y II, actualmente es utilizado para  espectáculos al aire libre (música, danza, teatro). Cuenta con lumínica básica  (reflectores) y personal técnico para acompañar las actividades. Tiene un costo  de usufructo, regido por ordenanza municipal tributaria.</p>
                 <p>(Los interesados en usufructuar deben  dirigirse a la Unidad de Espacios del CCC, para retirar requisitos y  condiciones de uso. Teléfonos 442-448, 447-683, int. 109; de lunes a viernes,  de 7:30 a 15:30 h. E-mail: <a href="mailto:direccion.manzana.rivera@gmail.com">direccion.manzana.rivera@gmail.com</a>; <a href="http://www.facebook.com/">www.facebook.com</a>).</p>
               </div>
              </section>
