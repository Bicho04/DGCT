        ...
        <nav id="botones-entidad">
              ...
              <!-- InstanceBeginEditable name="INFO" -->
               ...
               <div class="info">
                 ...
                 <p>R era el patio interno  de las casas Castelví y Serra I y II, actualmente es utilizado para  espectáculos al aire libre (música, danza, teatro). Cuenta con lumínica básica  (reflectores) y personal técnico para acompanar las actividades. Tiene un costo  de usufructo, regido por ordenanza municipal tributaria.</p>
