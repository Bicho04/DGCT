      ...
      <div id="cont-central">
        ...
        <section id="cont-info">
          ...
          <div class="info">
            ...
            <h2>Ballet Folckl&oacute;rico Municipal Asunci&oacute;n</h2>
          <img class="central" src="imagenes/fotos/Ballet Folclorico Municipal.jpg" alt="Ballet folclorico">
            <p>Está integrado actualmente por 16 bailarines. El repertorio del elenco incluye cuadros coreográficos inspirados en fiestas tradicionales, costumbres, labores del campo, leyendas, personajes y devociones populares.</p>
            <p>Con una trayectoria de 32 ańos de su creación, conformada por 8 parejas de bailarines, ha recorrido el país como el extranjero (Uruguay, Espańa, Argentina etc.) con participación en distintos festivales artísticos entre otras actuaciones. El Ballet Folklórico Municipal realiza sus presentaciones juntamente con la Banda Folklórica Municipal.</p>
            <p>Actualmente su directora es la Profesora Irma Catalina Avila de Carvallo</p>
