      ...
      <div id="cont-central">
        ...
        <nav id="botones-entidad">
             ...
             <section id="cont-info">
                <div class="info">
                    <h3>Sala</h3>
                   <h2>Sala de Reuniones Agustina Miranda</h2>
                   <img src="imagenes/fotos/Sala de Reuniones.jpg" alt="reuniones" class="central">
                  <p>Especial para reuniones de trabajo y charlas con capacidad para 60personas. Totalmente climatizada.</p>
                </div>
              </section>
