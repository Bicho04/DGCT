    ...
    <section id="central">
      ...
      <div id="cont-central">
        ...
        <section id="cont-info">
          <div class="info">
            <h3>Escuela de Locuci&oacute;n</h3>
            <p>Su objetivo es la formaci&oacute;n de locutores para radio y TV </p>
            <p>y animadores art&iacute;sticos.</p>
            <p>Contenido:</p>
            <p>-La Voz            -Radio </p>
            <p>-Televisi&oacute;n      -Animaci&oacute;n Art&iacute;stica</p>
            <p>Edad: Bachilleres.</p>
            <p>Horario: Lunes a Viernes de 19:00 a 21:30 horas</p>
            ...
            <p>T&iacute;tulo otorgado: Locutor de Radio, TV y Animaci&oacute;n Art&iacute;stica. </p>
            <p>Local:  Autores Paraguayos Asociados (A.P.A.) </p>
            <p> Chile c/ Alberdi.</p>
          </div>
        </section>
