      ...
      <div id="cont-central">
        ...
        <nav id="botones-entidad">
             ...
             <section id="cont-info">
                <div class="info">
                    <h3>Sala</h3>
                   <h2>Sala de Fisioterapia y Rehabilitación</h2><p>
Brinda servicio especial para la rehabilitación deportiva, la
rehabilitación traumatológica, neurológica y post quirúrgica. Está
equipada con equipos de última generación como ultrasonido- terapia,
magneto- terapia,  láser, tens (electro analgesia) electro-
