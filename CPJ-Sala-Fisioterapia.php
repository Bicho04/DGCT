      ...
      <div id="cont-central">
        ...
        <nav id="botones-entidad">
             ...
             <section id="cont-info">
                <div class="info">
                    <h3>Sala</h3>
                   <h2>Sala de Fisioterapia y Rehabilitaci&oacute;n</h2><p>
Brinda servicio especial para la rehabilitaci&oacute;n deportiva, la
rehabilitaci&oacute;n traumatol&oacute;gica, neurol&oacute;gica y post quir&uacute;rgica. Est&aacute;
equipada con equipos de &uacute;ltima generaci&oacute;n como ultrasonido- terapia,
magneto- terapia,  l&aacute;ser, tens (electro analgesia) electro-
estimuladores, infrarrojo,  vibro- masajeadores, termoterapia y
crioterapia.</p>
                </div>
              </section>
