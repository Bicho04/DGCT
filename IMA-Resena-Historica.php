    ...
    <section id="central">
      ...
      <div id="cont-central">
        ...
        <section id="cont-info">
            <div class="info">
            <h3>Reseńa Historica</h3>
            <p>El Instituto Municipal de Arte (IMA) es un centro de formación artística que forma parte de la Dirección General de Cultura y Turismo de la Municipalidad de Asunción.</p>
            <p>El IMA es una Institución de reconocido prestigio en el ámbito local e internacional, por el alto desempeńo de sus alumnos y está dirigido por la destacada actriz nacional  la  Sra. Margarita Irún desde el ańo 2010.</p>
            <p>El objetivo de esta Institución es promover y desarrollar la formación cultural de la comuna en el terreno de las artes y otras disciplinas técnicas, en favor de la capacidad expresiva y creadora de nuevos artistas.</p>
            <p>En este Instituto, reciben clases de las diversas disciplinas más de 700 alumnos entre nińos, jóvenes y adultos, e ingresantes en el ańo 2013 alrededor de 250 nuevos alumnos, atendidos por un calificado núcleo de especialistas con más de 100 miembros entre maestros, auxiliares y personal técnico.</p>
            <p>Antecedentes:</p>
            <p>La Dirección del IMA tiene su origen en el Departamento de Cultura y Arte iniciada en el ańo 1952 con la Intendencia del Ingeniero José Domingo Ocampo, posteriormente a través de la Resolución de Intendencia 361/64 se unifica varias Jefaturas existentes en el ámbito Municipal tales como Escuela de Arte Escénico, Escuela de Danza Folklórica,  y el Conservatorio Municipal de Música. Que posteriormente fueron constituyéndose por medio de Resoluciones emanadas de la Intendencia  nro. 211/64, también la Escuela Municipal de Arte Infantil  y la Escuela Municipal de Canto por Resolución nro. 112/66.</p>
