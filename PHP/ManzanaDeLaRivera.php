  ...
  <section id="contenido">
    <header id="cabecera">
      <section id="logo-grupo">
        <section id="logocult"><!-- InstanceBeginEditable name="logo img" --><a href="beta-index.php"><img src="imagenes/logo-09.png" alt="Manzana de la Rivera" ></a><!-- InstanceEndEditable --></section>
...
<!-- ******************************************************* -->
    ...
    <section id="central">
      <div class="titulo"><h1><!-- InstanceBeginEditable name="h1" -->Manzana de la Rivera<!-- InstanceEndEditable --></h1></div>
      <ul class="hovercal">
        <li>
