  ...
  <section id="contenido">
    <header id="cabecera">
      <section id="logo-grupo">
        <section id="logocult"><!-- InstanceBeginEditable name="logo img" --><a href="beta-index.php"><img src="imagenes/logo-07.png" alt="Diercción de Acción Cultural y Turismo" ></a><!-- InstanceEndEditable --></section>
...
<!-- ******************************************************* -->
    ...
    <section id="central">
      <div class="titulo"><h1><!-- InstanceBeginEditable name="h1" -->Diercción de Acción Cultural y Turismo<!-- InstanceEndEditable --></h1></div>
      <ul class="hovercal">
        <li>
  ...
  <!-- InstanceBeginEditable name="Eventos Nombre entidada #" -->
                  <?php $entidad="#";include("actividadesdeldia.inc.php");?>
                  <!-- InstanceEndEditable -->
