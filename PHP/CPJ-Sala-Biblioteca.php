      ...
      <div id="cont-central">
        ...
        <nav id="botones-entidad">
             ...
             <section id="cont-info">
                <div class="info">
                    <h3>Sala</h3>
                   <h2>Biblioteca Herib Campos Cervera</h2><p>Cuenta con más de 5000 volúmenes de libros y materiales de texto sobre temas variados de interés general.</p>
<p>Biblioteca Ymaguare: Perteneciente al acervo privado de la Fundación Ymaguaré, se encuentra dentro de la Biblioteca del CPJ mediante  un convenio entre la Municipalidad de Asunción y la Fundación Ymaguare.</p>
