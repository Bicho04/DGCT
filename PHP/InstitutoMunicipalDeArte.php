...
<!DOCTYPE html>
<html lang="es"><!-- InstanceBegin template="/Templates/Actividades-Entidad.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
  ...
  <section id="contenido">
    <header id="cabecera">
      <section id="logo-grupo">
        <section id="logocult"><!-- InstanceBeginEditable name="logo img" --><a href="beta-index.php"><img src="imagenes/logo-09.png" alt="Instituto municipal de arte de la ciudad de Asunción" ></a><!-- InstanceEndEditable --></section>
...
<!-- ******************************************************* -->
      ...
      <div id="amazingslider-1">
        <ul class="amazingslider-slides">
          <!-- InstanceBeginEditable name="Nombre fotos" -->
...
<!-- ******************************************************* -->
    ...
    <section id="central">
      <div class="titulo"><h1><!-- InstanceBeginEditable name="h1" -->Instituto Municipal de Arte<!-- InstanceEndEditable --></h1></div>
      <ul class="hovercal">
        <li>
        ...
        <div id="cont-central">
            <ul id="nav-inst">
			<!-- InstanceBeginEditable name="menu entidad" --><!--
              ...
              <nav id="botones-entidad">
                <ul id="botones-entidad-nav">
                  <!-- InstanceBeginEditable name="Botones Entidad" -->
                    <li><a href="#">Escuela de Musica</a></li>
                    <li><a href="#">Escuela de Danza</a></li>
                    <li><a href="#">Escuela de Teatro</a></li>
                    <li><a href="#">Taller Teatro</a></li>
                  <!-- InstanceEndEditable -->
                </ul>
              </nav>
  <!-- InstanceBeginEditable name="Eventos Nombre entidada #" -->
