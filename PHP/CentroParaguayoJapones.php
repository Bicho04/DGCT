  ...
  <section id="contenido">
    <header id="cabecera">
      <section id="logo-grupo">
        <section id="logocult"><!-- InstanceBeginEditable name="logo img" --><a href="beta-index.php"><img src="imagenes/logo-01.png" alt="Centro Paraguayo Japones" ></a><!-- InstanceEndEditable --></section>
...
<!-- ******************************************************* -->
    ...
    <section id="central">
      <div class="titulo"><h1><!-- InstanceBeginEditable name="h1" -->Centro Cultural Paraguayo Japones<!-- InstanceEndEditable --></h1></div>
      <ul class="hovercal">
        <li>
  ...
  <!-- InstanceBeginEditable name="Eventos Nombre entidada #" -->
                  <?php $entidad="a87ff";include("actividadesdeldia.inc.php");?>
                  <!-- InstanceEndEditable -->
