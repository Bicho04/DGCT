    ...
    <section id="central">
      ...
      <div id="cont-central">
        ...
        <section id="cont-info">
          <div class="info">
            <h3>Conservatorio de M&uacute;sica "Agustin Barrios"</h3>
            <p>Su objetivo es la formaci&oacute;n musical de j&oacute;venes y pueden realizar sus pr&aacute;cticas en la Orquesta</p>
            <p>Juvenil de Asunci&oacute;n.</p>
            <p>Contenido:  -Historia de la M&uacute;sica</p>
            <p> -Teor&iacute;a y Solfeo                -Armon&iacute;a </p>
            <p>Instrumentos: Cuerdas, vientos y percusi&oacute;n</p>
            <p>Edad: Ingreso de 9 a 16 a&ntilde;os.</p>
            <p>Horario: Lunes a Viernes de 14:30 a 19:00 horas</p>
            <p>Requisitos:*Fotocopia de certificado de nacimiento </p>
            <p>o c&eacute;dula de identidad acompa&ntilde;ado del original</p>
            <p>T&iacute;tulos otorgados:  -Profesor superior de M&uacute;sica           -Profesor de </p>
            <p>Instrumento.</p>
            <p>Local: Anglo. Juan de Salazar 331 e/ Pa'i P&eacute;rez y Artigas.</p>
          </div>
        </section>
