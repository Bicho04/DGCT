      ...
      <div id="cont-central">
        ...
        <section id="cont-info">
          <div class="info">
            ...
            <p>Su objetivo es la formaci&oacute;n de bailarines y/o profesores de danza</p>
            <p>Contenido:</p>
            <p> -Danza Folklorica </p>
            <p> -Danza cl&aacute;sica </p>
            <p> -Danza contempor&aacute;nea.</p>
            <p> -Especializaci&oacute;n en base a aptitudes</p>
            <p> -Docencia, coreograf&iacute;a, etc</p>
            <p>Edad: desde los 7 a&ntilde;os.</p>
            <p>Horario: Lunes a Viernes 14:30 a 20:00 horas</p>
            <p>Requisitos: Fotocopia de certificado de nacimiento</p>
            <p>o c&eacute;dula de identidad acompa&ntilde;ado del original.</p>
            <p>T&iacute;tulo otorgado: Profesor Superior de Danzas</p>
            <p>Local: Uni&oacute;n Club. Palma e/ Oleary y Ayolas.</p>
          </div>
        </section>
