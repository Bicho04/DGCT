      ...
      <div id="cont-central">
        ...
        <nav id="botones-entidad">
             ...
             <section id="cont-info">
                <div class="info">
                    <h3>Sala</h3>
                    <h2>Anfiteatro Oscar Cardozo Ocampo</h2>
                    <img src="imagenes/fotos/Seminario.jpg" class="central">
              <p>Espacio para la realizaci&oacute;n de actividades culturales al aire libre.</p>
                    <p>Con capacidad para 1000 personas. Con sanitarios sexados en los laterales.</p>
                </div>
              </section>
