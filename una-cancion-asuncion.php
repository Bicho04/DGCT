...
<!-- ******************************************************* -->
    ...
    <section id="derecha">
      <section id="agenda">
        ...
        <h2> 22° Festival Internacional de cine</h2>
         <span>
                   <!--a href="#">Baudilio Alio</a-->
                   <a href="plantilla.php?tema=37#actividades">Cine</a>
                   <a href="TeatroMunicipal.php">Teatro Municipal </a>
                
                 </span><h4 id="hora">09:30 hs.</h4>
     <h4>09-09-2013 al 03-10-2013 </h4>
                        <img src="images/noti228/22festival-de-cine.jpg" >
             <!--img src="admin/mostrar.php?noti=imagen&id=151"-->
         <p>
          &nbsp;Lanzamiento Oficial del 22&deg; Festival Internacional de Cine, Arte y Cultura de Asunci&oacute;n 2013 presentado por la Municipalidad de Asunci&oacute;n.<br /><strong>Lugar:</strong> Baudilio Ali&oacute;. Teatro Municipal.          
