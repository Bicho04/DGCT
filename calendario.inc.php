...
if($entidad!=1):
	$link=$Lorigen[$entidad];
	$link="<a href='".$link."?dia=$day&mes=$month&anio=$year&entidad=$entidad#actividades' target='_top'>$texto</a>";
else:
	$link="<a href='plantilla.php?dia=$day&mes=$month&anio=$year#actividades' target='_top'>$texto</a>";
endif;
