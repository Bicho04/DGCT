      ...
      <div id="cont-central">
        ...
        <nav id="botones-entidad">
             ...
             <section id="cont-info">
                <div class="info">
                    <h3>Sala</h3>
                   <h2>Biblioteca Herib Campos Cervera</h2><p>Cuenta con m&aacute;s de 5000 vol&uacute;menes de libros y materiales de texto sobre temas variados de inter&eacute;s general.</p>
<p>Biblioteca Ymaguare: Perteneciente al acervo privado de la Fundaci&oacute;n Ymaguar&eacute;, se encuentra dentro de la Biblioteca del CPJ mediante  un convenio entre la Municipalidad de Asunci&oacute;n y la Fundaci&oacute;n Ymaguare.</p>
<p>Especializada en Historia Paraguaya de autores nacionales einternacionales. Es utilizada por investigadores e historiadores.</p>
                </div>
              </section>
