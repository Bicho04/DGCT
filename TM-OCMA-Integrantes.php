        ...
        <nav id="botones-entidad">
              ...
              <section id="cont-info">
                ...
                <div class="info">
                 ...
                 <h2>Orquesta de C&aacute;mara Municipal de Asunci&oacute;n</h2>

                 <p><strong>Director</strong><strong> </strong><br>

Miguel A. Echeverr&iacute;a</p>
                 <div class="columna">

                 <p><strong>Concertino</strong><br>

                   Rub&eacute;n Jara</p>
                   </div>
                 <div class="columna">

                 <p><strong>Viol&iacute;n</strong><br>
                 ...
                 <p><strong>Violoncello</strong><br>
                   ...
                   Juan Ch&aacute;vez<br>

                   Oswaldo Rodr&iacute;guez</p>
                   </div>
                 <div class="columna">

                 <p><strong>Contrabajo</strong><br>

                   Carlos Balbuena</p>
                   </div>
                 <div class="columna">

                 <p><strong>Flauta</strong><br>

                   Sim&oacute;n Santander</p>
                   </div>
                 <div class="columna">
                 ...
                 <p><strong>Clavec&iacute;n</strong><br>

                   C&eacute;sar Barrios</p>
                   </div>
                 <div class="columna">
