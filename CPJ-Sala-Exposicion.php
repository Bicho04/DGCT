      ...
      <div id="cont-central">
        ...
        <nav id="botones-entidad">
             ...
             <section id="cont-info">
                <div class="info">
                    <h3>Sala</h3>
                   <h2>Sala de Exposiciones Jacinto Rivero</h2><p> Totalmente alfombrada y climatizada. Utilizada por j&oacute;venes yconsagrados artistas de las m&aacute;s diversas disciplinas art&iacute;sticas.</p>
                </div>
              </section>
