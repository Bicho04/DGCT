      ...
      <div id="cont-central">
        ...
        <nav id="botones-entidad">
             ...
             <section id="cont-info">
                <div class="info">
                    <h3>Cursos</h3>
                    <h2>En Artes Visuales</h2>
                    <img src="imagenes/fotos/SDC11886.jpg" class="central">
                  <p>el Centro Paraguayo Japon&eacute;s ofrece Clases de Dibujo Art&iacute;stico y Pintura al &oacute;leo para ninos, j&oacute;venes y adultos. </p>
                </div>
              </section>
