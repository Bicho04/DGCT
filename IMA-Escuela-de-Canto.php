    ...
    <section id="central">
      ...
      <div id="cont-central">
        ...
        <section id="cont-info">
          <div class="info">
            <h3>Escuela de Canto "Sof&iacute;a Mendoza"</h3>
            <p>Su objetivo es la formaci&oacute;n en el Canto y el conocimiento de la M&uacute;sica.</p>
            <p>Contenido:</p>
            <p>-Historia de la M&uacute;sica        -Teor&iacute;a y Solfeo</p>
            <p>-T&eacute;cnica vocal                      -Canto</p>
            <p>-Coro                                     -Piano</p>
            <p>Edad:  Ingreso mujeres desde 15 a&ntilde;os.</p>
            <p>Ingreso varones desde 16 a&ntilde;os. </p>
            <p>Horario: Lunes a Viernes 17:00 a 20:00 horas</p>
            <p>Requisitos: *Fotocopia de certificado de nacimiento </p>
            <p>o c&eacute;dula de identidad acompa&ntilde;ado del original.</p>
            <p>T&iacute;tulo otorgado:  Profesor Superior de M&uacute;sica </p>
            <p>Profesor Superior de Canto.</p>
            <p>Local:   Colegio Pte. Franco. </p>
            <p>Azara e Independencia Nacional.</p>
          </div>
        </section>
